...
export function Code() {
  return (
    <div className={`${courierPrime.className} antialiased flex h-full`}>
      {/* Left panel — never scrolls, image stays pinned */}
      <div className="w-[20%] shrink-0 flex flex-col items-center pt-48 px-8">
        <Image
      ...
      <div
        className="flex-1 overflow-y-scroll pt-48 pb-20 pr-20 pl-4 [&::-webkit-scrollbar]:hidden"
        style={{ scrollbarWidth: "none" }}
      >
        <div className="flex flex-col justify-start">
          <h2 className="text-neon-blue text-xl font-bold">
            Senior Frontend Engineer / React / Next.js / TypeScript / AI-Powered
            Products
          </h2>
          <ul className="border-l border-gray-400 py-2 px-10 mx-4 my-4">
            <li className="text-neon-green text-xl font-bold">
              Seville, Spain
            </li>
            <li className="text-neon-green text-xl font-bold">
              +34 695 135 544
          ...
          <h2 className="text-neon-yellow text-xl font-bold">
            Professional Summary
          </h2>
          <p className="text-xl text-neon-blue font-bold border-l border-gray-400 py-2 px-10 mx-4 my-4">
          ...
          <ul className="border-l border-gray-400 py-2 px-10 mx-4 my-4">
            <li className="text-neon-blue text-xl font-bold">
          ...
          <div className="border-l border-gray-400 py-2 px-10 mx-4 my-2">
            {WORK_EXPERIENCES.map((e) => (
              <Experience key={e.id} {...e} />
            ))}
          </div>
          <h2 className="text-neon-yellow text-xl font-bold">Education</h2>
          <div className="border-l border-gray-400 py-2 px-10 mx-4 my-2">
            {EDUCATION.map((e) => (
